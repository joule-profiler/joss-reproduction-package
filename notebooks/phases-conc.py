...
def _():
    ...
    #         def run_profiler():
    #             _proc = profiler_exec(f"programs/timer/target/release/timer {_interval_ms} {_nb_samples} false", profiler_path=PROFILER_PATH, output_file=_profiler_out, taskset=_taskset, profiler_takset=_profiler_taskset)
